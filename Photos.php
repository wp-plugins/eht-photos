...
define ("EHT_PHOTOS_PLUGIN_VERSION", "0.8");
	...
	switch ($page)
	{
		...
		case EHT_PHOTOS_SUBPAGE_PHOTOS:
			...
			foreach ($rows as $row)
			{
				...
				echo "   <tr class=\"$class\">\n" .
					 "      <td valign=\"top\"><a href=\"$href" . EHT_PHOTOS_FIELD_ORDER . "=$order&" . EHT_PHOTOS_FIELD_DIRECTION . "=$direction&" . EHT_PHOTOS_FIELD_ACTION . "=" . EHT_PHOTOS_ACTION_RESET . "&" . EHT_PHOTOS_FIELD_ID . "=" . $id . "\" border=\"0\"><img src=\"" . EHT_PHOTOS_PLUGIN_URL_BASE_IMAGES . EHT_PHOTOS_ICON_RESET . "\" border=\"0\" title=\"Reset views counter\"></a></td>\n" .
					 "      <td valign=\"top\">$id</td>\n" .
